(function() {
var __options = {}, __timer = {}, __less = {}, __customevents = {}, __protocol = {}, __connector = {}, __reloader = {}, __livereload = {}, __startup = {};
...
__reloader.Reloader = Reloader = (function() {
  ...
  Reloader.prototype.reloadStylesheet = function(path) {
    var imported, link, links, match, style, _i, _j, _k, _len, _len1, _len2, _ref;
    links = (function() {
      var _i, _len, _ref, _results;
  ...
  LiveReload.prototype.processPluginCommand = function(message) {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      if (plugin.constructor.identifier === message.identifier) {
        if (plugin != null) {
          if (typeof plugin.processCommand === "function") {
